...
% no_of_est_para : number of estimated parameters (used for computing error)

%function [error,true_pos,true_neg,false_pos,false_neg] = comp_error(Atrue,Ahat,n,no_of_est_para)
function [true_pos,true_neg,false_pos,false_neg] = comp_error(Atrue,Ahat)
...
%error = (false_pos + false_neg)/no_of_est_para;